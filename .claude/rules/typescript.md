...
| Required Type | Where to Import From |
| --- | --- |
...
Before writing code — look at the required `.d.ts` file:
...
// ✅ Import FormDataType and narrow with a type guard (Record<string, unknown> variant does not contain marker)
