...
Creates a flow for paid subscriptions through the `Subscriptions` module of OneEntry: displaying available plans, subscribing with a redirect to payment, cancellation, and recovery.
...
File: `src/app/hooks/useSubscriptions.ts`
...
File: `src/app/components/SubscriptionPlans.tsx`
...
```tsx
// src/app/[locale]/subscription/success/page.tsx — Client Component
'use client';
